...
print Q ") >$logfile\n";
print Q "if ! which acquire-gpu &> /dev/null; then\n";
print Q "   echo 'command not found: acquire-gpu not found.'\n";
print Q "   exit 1\n";
print Q "fi\n";
print Q "for _ in \$(seq $cli_options{'gpu'}); do source acquire-gpu; done\n";
